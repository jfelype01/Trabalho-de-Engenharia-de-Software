...
// CLASSE RENOMEADA PARA CORRESPONDER AO NOME DO ARQUIVO E À INTENÇÃO
class FrequenciaDoDiaScreen extends StatelessWidget {
  ...
  FrequenciaDoDiaScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Frequência do Dia'), // Título atualizado
